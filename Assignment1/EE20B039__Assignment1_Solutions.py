'''
-------------------------------------
Applied Programming Lab(APL)-EE2703
 Assignment 1-Solutions
 Done by Gugulothu Naveen
 EE20B039
...
# For Extracting a tokens from a Line
def line2tokens(spiceLine):
    allWords = spiceLine.split()

    # Resistance(R),Inductor(L),Capacitance(C), Independent Sources
    if(len(allWords) == 4):  
        ...
        try:
            ...
            if (not circuitFile.endswith(".netlist")):
                ...
                with open (circuitFile, "r") as f:
                    ...
                    try:
                        # to find the location of the identifiers
                        ...
                        #  For Printing Circuit Definition in Reverse Order
